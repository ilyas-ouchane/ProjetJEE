						    				...
						    				<div class="room-wrap d-md-flex ftco-animate">
						    					...
						    					<div class="half left-arrow d-flex align-items-center">
						    						<div class="text p-4 text-center">
						    							<p class="mb-0"><p>${h.getNbr_etoiles()} Etoiles</p>
						    							<p class="mb-0"><span class="price mr-1">${h.getNom_hotel()}</span> <span class="per">per night</span></p>
							    						<h3 class="mb-3"><a href="#"><p>${h.getVille_hotel()}</p></a></h3>
							    						<p class="pt-1"><a href="GetOneHotelData?hotel=<c:out value="${h.getId_hotel()}"/>" class="btn-custom px-3 py-2 rounded">View Details <span class="icon-long-arrow-right"></span></a></p>
						    						</div>
						    					</div>
						    				</div>
						    			</div>
